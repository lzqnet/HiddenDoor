...
package com.zql.hitactions.StateMachine;
...
public class StateMachine {
    ...
    private static class LogRecords {
         ...
         * processed.
         */
        synchronized void add(StateMachine sm,
                              Message msg,
                              String messageInfo,
                              IState state,
                              IState orgState,
    ...
    private static class SmHandler extends Handler {
        ...
        private final StateInfo addState(State state, State parent) {
            if (mDbg) {
                mSm.log("addStateInternal: E state=" + state.getName() + ",parent=" + ((parent == null) ? ""
                    : parent.getName()));
            }
        ...
        private class StateInfo {
            ...
            @Override
            public String toString() {
                return "state=" + state.getName() + ",active=" + active + ",parent=" + ((parentStateInfo == null)
